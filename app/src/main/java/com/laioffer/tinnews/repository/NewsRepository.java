...
public class NewsRepository {
    ...
    //fetch data
    //async call
    //livadata: listen the change, like listener.
    public LiveData<NewsResponse> getTopHeadlines(String country) {
        //create an empty mutablelivedata, when response is back, set data to mutablelivadata
        //response header contains successful
